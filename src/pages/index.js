...
export default function index() {
  return (
    <Layout>
      ...
      <ShowroomSection />
      <MainVideo />
      <ImageLeft img={LandscapingImg} alt="landscaping services in calgary, AB" subheader="" title="Landscaping services in Calgary" body="Since 2016, Project landscape has helped hundreds of homeowners create beautiful and functional outdoor living spaces that are filled with relaxation and enjoyment. Whether it's a complete landscape design and construction transformation or helping homeowners create a jaw-dropping curb appeal to be the envy of your neighbours, experienced and certified landscaping professionals are here to help.
